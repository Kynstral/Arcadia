      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Welcome to Arcadia, your library management system
          </p>
        </div>
                  ...
                  <ul className="space-y-4">
                    {stats.popularBooks.slice(0, 5).map((book) => (
                      <li key={book.id} className="flex items-center">
                        <div className="h-12 w-9 bg-secondary rounded overflow-hidden shrink-0">
                          {book.coverImage && (
                            <img
                              src={book.coverImage}
                              alt={book.title}
                  ...
                  <ul className="space-y-4">
                    {userBorrowings.slice(0, 5).map((borrowing) => (
                      <li key={borrowing.id} className="flex items-start group">
                        <div className="rounded-full bg-secondary p-1.5 shrink-0">
