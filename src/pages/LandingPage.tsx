      ...
      >
        <div className="container px-4 md:px-6">
          ...
          <div className="mx-auto grid max-w-6xl grid-cols-1 gap-8 py-12 md:grid-cols-2 lg:grid-cols-3">
            <div className="group flex flex-col h-full space-y-4 rounded-xl border p-6 shadow-xs bg-card hover:shadow-md transition-all duration-300 hover:border-primary/30 hover:translate-y-[-4px]">
      ...
      >
        <div className="container px-4 md:px-6">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div className="flex flex-col justify-between rounded-xl border bg-card p-6 shadow-xs hover:shadow-md transition-all duration-300 hover:border-primary/20">
              <div className="mb-4">
                ...
                <p className="mb-4 text-base italic leading-relaxed text-muted-foreground">
                  "Arcadia has transformed how we manage our university library.
            ...
            <div className="flex flex-col justify-between rounded-xl border bg-card p-6 shadow-xs hover:shadow-md transition-all duration-300 hover:border-primary/20">
              <div className="mb-4">
                ...
                <p className="mb-4 text-base italic leading-relaxed text-muted-foreground">
                  ...
                  yet powerful. Arcadia exceeded our expectations in every way.
        ...
        <div className="container px-4 md:px-6 relative">
          ...
          <div className="relative mx-auto max-w-3xl text-center">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-8 max-w-2xl mx-auto">
              Join thousands of libraries that trust Arcadia for their
