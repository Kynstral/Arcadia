                          ...
                          <div className="flex flex-col">
                            <div className="flex items-center border-b px-3 dark:border-slate-800">
                              ...
                              <input
                                ...
                                className="flex h-10 w-full rounded-md bg-transparent py-3 text-sm outline-hidden placeholder:text-slate-500 disabled:cursor-not-allowed disabled:opacity-50"
                              />
                            </div>
                                    ...
                                    {bookSearchResults.map((book) => (
                                      ...
                                      >
                                        <div className="flex items-start gap-2 w-full">
                                          <div className="h-10 w-8 bg-muted flex items-center justify-center shrink-0">
                                            {book.coverImage ? (
                                              <img
                                                src={book.coverImage}
                                                alt={book.title}
                      ...
                      <Card className="mt-4">
                        <CardContent className="p-4">
                          <div className="flex gap-4">
                            <div className="h-24 w-16 bg-muted flex items-center justify-center shrink-0">
