      ...
      <main className="container mx-auto px-4">
        ...
        {cart.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-fade-in">
                ...
                <CardContent className="p-0">
                  <div>
                    {cart.map((item, index) => (
                      ...
                      >
                        <div className="h-24 w-16 bg-muted rounded overflow-hidden shrink-0 mr-4 shadow-xs">
                          <img
            ...
            {/* Order Summary */}
            <div>
              <Card className="border shadow-xs sticky top-4">
                <CardHeader className="border-b bg-muted/30 pb-4">
        ...
        <DialogContent className="sm:max-w-md max-h-[90vh] overflow-y-auto">
          ...
          <div className="my-4">
            <div className="mb-4 flex justify-between items-center">
              ...
              <Badge
                variant={checkoutMode === "purchase" ? "default" : "outline-solid"}
                className="text-xs"
              >
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-3 max-h-[200px] overflow-y-auto pr-1">
              {cart.map((item) => (
                ...
                >
                  <div className="h-16 w-12 bg-muted rounded overflow-hidden shrink-0 mr-3">
                    <img
                      src={item.coverImage || "/placeholder.svg"}
                      alt={item.title}
                      className="h-full w-full object-cover"
